...
import logging
from geo.text2png import text2png
logging.basicConfig(level=logging.INFO)
uptime = DT.datetime.now()

exec(open("driww/var.txt","r").read())
bot = TelegramClient("driww","6","eb06d4abfb49dc3eeb1aeb98ae0f581e").start(bot_token=BOT_TOKEN)
try:
	open("driww/database.db")
except:
	x = sqlite3.connect("driww/database.db")
	c = x.cursor()
